...
#ifdef GROUPS1
		std::vector<unsigned short> state_filter;
		unsigned short *filter_table_;
		unsigned short *d_filter_table_;
#else
...
#ifdef GROUPS1
		unsigned short *get_d_filter_table() const;
		unsigned short *get_filter_table();
#else
